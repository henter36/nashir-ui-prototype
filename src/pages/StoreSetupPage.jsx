...
function SmartBox({ step }) {
  const tips = {
    ...
    2: ["المنتجات هنا ستُستخدم كمدخلات للحملات القادمة.", "لا تجعل هامش الربح إلزاميًا في V1."],    3: ["الجمهور الافتراضي يجب أن يكون خفيفًا وقابلًا لإعادة الاستخدام.", "تجنب الحقول التخمينية مثل الدخل والاهتمامات العامة."],
