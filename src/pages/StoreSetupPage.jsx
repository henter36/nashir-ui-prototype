...
function SmartBox({ step }) {
  const tips = {
    ...
    2: ["المنتجات هنا ستُستخدم كمدخلات للحملات القادمة.", "لا تجعل هامش الربح إلزاميًا في V1."],    4: ["القنوات هنا تختصر بدء OAuth، وليست مكان إدارة الأسرار.", "الإعدادات وإعداد المتجر يقرآن نفس مصدر الربط؛ لا مزامنة يدوية."],
